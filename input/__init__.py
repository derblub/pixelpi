...
Key = enum(X=1, Y=4, A=2, B=3, L1=5, R1=6, L2=7, R2=8, SELECT=9, HOME=10, UP=11, DOWN=12, LEFT=13, RIGHT=14, BACK=15,
           ENTER=16)

TOTAL_KEYS = 17

_verbose = S.get('dev', 'debug')
...
controller = S.get('others', 'controller')
